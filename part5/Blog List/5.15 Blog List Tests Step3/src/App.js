...
const App = () => {
   ...
   const deleteBlog = async (id) => {
      ...
      showNotification(`Blog id ${id} has been deleted successfully`, true)
   }
   ...
   return (
      <div>
         ...
         {blogs.map(blog =>
            <Blog key={blog.id} blog={blog} updateBlog={updateBlog} deleteBlog={deleteBlog} getBlogs={getBlogs} showNotification={showNotification} />
         )}
      </div>
   )
}
